 ...
 */
ssd1306::ssd1306(i2c_inst *pI2cP, uint16_t deviceAddressP, uint16_t widthP, uint16_t heightP) :
...
void ssd1306::sendCmd(uint8_t cmdP)
{
    // I2C write process expects a control byte followed by data
    // this "data" can be a command or data to follow up a command
    // Co = 1, D/C = 0 => the driver expects a command
    uint8_t buf[2]{0x80, cmdP};
    i2c_write_blocking(pSsd1306I2cM, addressM, buf, 2, false);
}
...
void ssd1306::show()
{
    ...
    i2c_write_blocking(pSsd1306I2cM, addressM, bufferM.get(), sizeM, false);
}
