...
public:
    static bool isValidString(const uint8_t* data, size_t len, size_t fieldSize);
};
...
public:
    ...
    [[nodiscard]] CredentialField getCurrentField() const { return currentField; }
    ...
    // Retrieval
    [[nodiscard]] const char* getWifiSSID() const { return buffers[0].c_str(); }
